...
gp4_lego::math::VectorJd controller_goal = Eigen::MatrixXd::Zero(6, 1);
...
int main(int argc, char **argv)
{
    try
    {
        ...
        // gp4_lego::udp::UDP_Interface::Ptr robot_connection = std::make_shared<gp4_lego::udp::UDP_Interface>();
        gp4_lego::math::VectorJd q;
        ...
        gp4_lego::math::VectorJd jerk_ref = Eigen::MatrixXd::Zero(6, 1);
        gp4_lego::math::VectorJd jerk_safe = Eigen::MatrixXd::Zero(6, 1);
        // gp4_lego::udp::recv_pack recv_packet;
